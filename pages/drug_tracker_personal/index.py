...
def get_columns(hide_sensitive):
    return ["Alcohol", "Nicotine"] if hide_sensitive else ["Alcohol", "Nicotine", "Weed"]
...
@app.callback(
    ...
    [
        ...
        Input("drug-hide-sensitive", "value"),
        Input("occurence-range", "value"),
    ],
)
def update_intake(diagram_type, hide_sensitive, occurence_range=None):
    relevant_columns = get_columns(hide_sensitive)
...
@app.callback(
    ...
    [
        ...
        State("drug-hide-sensitive", "value"),
    ],
)
def update_kpi(relayout_data, hide_sensitive):
    relevant_columns = get_columns(hide_sensitive)
    if (
